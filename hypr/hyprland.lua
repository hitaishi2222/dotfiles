...
local powermenu = "~/Hiti/dotfiles/scripts/rofi_scripts/rofi_sys.sh"
local screenshot = "~/Hiti/dotfiles/scripts/rofi_scripts/rofi_screenshot.sh"
local clipboard = "clipcat-menu"
local speech_to_text = "~/Hiti/dotfiles/scripts/stt.sh"
...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("asusd & mpd &")
	hl.exec_cmd("swayosd-server & fcitx5 &")
end)
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { wallust.color14, wallust.color1 }, angle = 45 },
...
-- hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("XDG_CURRENT_DESKTOP=sway flameshot gui"))
...
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd('grim -g "$(slurp)" - | tesseract stdin stdout | wl-copy '))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("/home/hiti/.local/bin/handy --toggle-transcription"))
...
-- Move window with mainmod + arrowkeys
...
hl.bind(
	...
	hl.dsp.exec_cmd("swayosd-client --output-volume raise --max-volume 120"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd("swayosd-client --output-volume lower --max-volume 120"),
	{ locked = true, repeating = true }
)
hl.bind(
	"XF86AudioMute",
